...
public class ModelSlowpokeHat extends Model {
    ...
    public ModelSlowpokeHat() {
        ...
        this.Shape1_1 = new Cuboid(this, 32, 1);
        ...
        this.Shape1_4 = new Cuboid(this, 32, 8);
        ...
        this.Shape1 = new Cuboid(this, 0, 16);
