 ...
 */
public class HalloweenFeatureRenderer extends FeatureRenderer<EntityPetRock, ModelPetRock<EntityPetRock>> {

    private final ModelCreeperHat hat = new ModelCreeperHat();
    private static final Identifier skin = new Identifier(Reference.MOD_ID, "textures/entity/event/creeper.png");

    public HalloweenFeatureRenderer(FeatureRendererContext<EntityPetRock, ModelPetRock<EntityPetRock>> featureRendererContext) {
